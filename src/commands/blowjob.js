...
/** @param {Command} args */
export default async function blowjobCommand({
  ...
  const caption = `@${mentionedNumbers[0]} está lamiendo/chupando el miembro de @${mentionedNumbers[1]}...`;

  const result = await api.waifupics.get('blowjob');
